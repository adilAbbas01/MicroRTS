...
public class FortressBoomRush64x64Delegate extends AbstractionLayerAI {
    ...
    public FortressBoomRush64x64Delegate(UnitTypeTable a_utt) {
    ...
    @Override
    public AI clone() {
        FortressBoomRush64x64Delegate clone = new FortressBoomRush64x64Delegate(utt);
